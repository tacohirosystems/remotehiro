-- Deploy remotehiro:20260111084106_jobs_location_salaries_init to sqlite
...
CREATE INDEX idx_currencies_currency_id ON currencies(currency_id);

INSERT INTO currencies(currency_id, code, symbol)
VALUES
  (1, 'EUR', '€'),
  (2, 'USD', '$'),
  (3, 'JPY', '¥'),
...
CREATE TABLE jobs_location_salaries(
