-- Deploy remotehiro:20260118174649_jobs_location_salaries_add_pk to sqlite

BEGIN IMMEDIATE;

CREATE TABLE temp_jobs_location_salaries(
  job_location_salary_id INTEGER PRIMARY KEY AUTOINCREMENT,
...
INSERT INTO temp_jobs_location_salaries(
  job_id,
  region_id,
  subregion_id,
  country_id,
